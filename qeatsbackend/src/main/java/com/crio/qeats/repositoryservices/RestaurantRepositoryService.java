...
public interface RestaurantRepositoryService {
  ...
  @Async
  CompletableFuture<List<Restaurant>> findRestaurantsByNameAsync(Double latitude, 
  ...
  @Async
  CompletableFuture<List<Restaurant>> findRestaurantsByItemAttributesAsync(Double latitude, 
          Double longitude,String searchString, LocalTime currentTime, Double servingRadiusInKms);
