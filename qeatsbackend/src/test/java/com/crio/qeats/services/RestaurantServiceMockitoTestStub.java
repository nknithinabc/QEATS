...
public class RestaurantServiceMockitoTestStub {
  ...
  public void initializeRestaurantObjects() throws IOException {
    ...
    assertEquals("11", restaurants[0].getRestaurantId());
    assertEquals("12", restaurants[1].getRestaurantId());
    assertEquals("13", restaurants[2].getRestaurantId());
    assertEquals("14", restaurants[3].getRestaurantId());
    assertEquals("15", restaurants[4].getRestaurantId());
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    //verify(restaurantRepositoryServiceMock, times(1))
    //    .findAllRestaurantsCloseBy(20.0,30.0,LocalTime.of(3,0),5.0);
